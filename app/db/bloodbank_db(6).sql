...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2021 at 08:22 PM
...
INSERT INTO `admin` (`id`, `username`, `password`, `name`, `nic`, `assigned`, `email`, `mobile`, `acl`, `deleted`) VALUES
(1, 'admin', 'admin', 'Tharindu Maduranga', NULL, 'Jaffna', NULL, NULL, '[\"Admin\"]', 0),
(2, 'superadmin', '123456', 'Tharindu', NULL, NULL, NULL, NULL, '[\"Super_admin\"]', 0),
(3, 'tharindu1', '14', 'gv', NULL, NULL, 'maduranga.tharidu@gmail.com', 762247830, NULL, 0),
(4, 'admin24', 'tharinduma73', 'Tharindu Madurnga', NULL, NULL, 'ceteja5424@wawue.com', 762247830, '[\"Admin\"]', 0);
...
(5, '[', '$2y$10$hSwA9zZ/ca.wRrpNAHjy1uI018JXM3ocKHOK4JV4rRdFLPNr6PNRm', 'fdhfhh', NULL, NULL, 'dfgfdggdfg@dsf.com', NULL, 'ghjghjgh', NULL, 0, NULL, NULL, '97366533576V', NULL),
(6, '[', '$2y$10$K8TQCLy6oObGX.eqRlxWueb0D4CyF/VYApHzZXpvdRxg4mcI6kAtC', 'maduranga', NULL, NULL, 'dfgfdgdsfg@dsf.com', NULL, 'asd', NULL, 0, NULL, NULL, '973533576V', NULL),
(7, '[', '$2y$10$puldzPgZtzIfBLlPQMYhXe.O7B8pgqldSDDUz8zgsSWkY/wVNg6uS', 'donor3s', NULL, NULL, 'dfgfdssgdfg@dsf.com', NULL, 'asdad asdada', NULL, 0, NULL, NULL, '973543576V', NULL),
(8, '[\"Doctor\"]', '$2y$10$2f9LcRDvEk9TrpVWUxYHWe6QjNr8BdT295aqIncVxZZFKqxUylKqi', 'fghhgfyh', NULL, NULL, 'dfgfdgd4fg@dsf.com', NULL, 'fds dfgd', NULL, 0, NULL, NULL, '973533576V', NULL),
(9, '[\"Nurse\"]', '$2y$10$ShsouBzGv7buSHR4TREaCe7Jh2wo1CiBP7.TO4j9SFI.WcgczXUmy', 'tharindu126', NULL, NULL, 'dfgfdgfgdfg@dsf.com', NULL, 'Tharindu Maduranga', NULL, 0, NULL, NULL, '973533576V', NULL),
(10, '[\"Doctor\"]', '$2y$10$3bJ1DVUOZVyIjie9rvUIo.r53w8CiywMWg7OYliZk.t.n9gIrbRQ.', 'asdaddad', NULL, NULL, 'dfgfdsgdfg@dsf.com', NULL, 'asd adafgfg', NULL, 0, NULL, NULL, '973533576V', NULL),
(11, '[\"Doctor\"]', '$2y$10$SZ1ZsgqIEHFPpuclbC5rruyYpdlTFCLLZ4KR2.9c0yKBQCkEFHuU2', 'dfgdgdgdg', NULL, NULL, 'dffgfdgdfg@dsf.com', NULL, 'dfgdfg dfgdgd', NULL, 0, NULL, NULL, '973533576V', NULL),
(12, '[\"Doctor\"]', '$2y$10$s.Zao9sq5i7cPZ/av5XnDOp.MqHkTFo.U8UWO6BWa8ryxQZjumECy', 'tharindu456', NULL, NULL, 'maduranga.tharidu@gmail.com', NULL, 'Tharindu maduranga', NULL, 0, NULL, NULL, '973533576V', 'FKpmxbMZ5LY8gnZJtJXwbuyyQxaA673z'),
(13, NULL, '$2y$10$i3pt2Qxv.avewDaoxxIl8O6Y0qQ1Sr8lKDrzAUXSBD3kud16YaphK', '4566asdasd', NULL, NULL, 'xinepoj601@vefblogg.com', NULL, 'Tharindu Maduranga', NULL, 0, NULL, NULL, '973533576V', NULL),
(17, '[\"MLT\"]', '$2y$10$rO1SHPpQE5HA1h.luonjyesHokLZpRnVJNPefdvLCWRQ.HKUDgg26', 'donor3245', NULL, NULL, 'revovir303@u461.com', NULL, 'Tharindu Maduranga', NULL, 0, NULL, NULL, '973533576V', NULL);
...
(0, 1, '6766aa2750c19aad2fa1b32f36ed4aee', 'Mozilla (Windows NT 10.0; Win64; x64; rv:93.0) Gecko Firefox', NULL);
...
--
-- Constraints for table `removed`
--
ALTER TABLE `removed`
  ADD CONSTRAINT `removed_ibfk_1` FOREIGN KEY (`bld_bank`) REFERENCES `hospital` (`name`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`name`) REFERENCES `hospital` (`name`);
COMMIT;
