						...
						<form action="<?= PROOT ?>donor/login" method="post" class="form">
							...
							<div class="form-group d-md-flex">
								...
								<div class="w-50 text-md-right">
									<a href="<?= PROOT ?>donor/forgetPassword" style="color: #fff">Forgot Password</a>
								</div>
							</div>
						</form>
						<p class="w-100 text-center"> Don't have an account ? <a href="<?= PROOT ?>donor/register">
								<font color="blue">click here to register</font>
							</a> </p>
