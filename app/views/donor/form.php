	...
	<form action="<?= PROOT ?>donor/form" method="post" id="wizard">
		...
		<section>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_1_1" id="_1_1" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_1_1" id="_1_1" value="ke;">
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-input" type="text" name="_1_2" id="_1_2">
			...
			<div class="row">
				...
				<div class="column2">
					<input type="date" class="form-control" name="_1_3" id="_1_3">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_1_4" id="_1_4" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_1_4" id="_1_4" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<textarea name="_1_5" id="_1_5" rows="2" cols="20">
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_1_6" id="_1_6" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_1_6" id="_1_6" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_1_7" id="_1_7" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_1_7" id="_1_7" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_2_1" id="_2_1" value=" Tõ " required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_2_1" id="_2_1" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="column4">
						...
						<input class="form-check-input" type="checkbox" name="_2_2_1" id="_2_2_1" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							හෘද රෝග
						</label><br><br>
						<input class="form-check-input" type="checkbox" name="_2_2_2" id="_2_2_2" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							දියවැඩියාව
						</label><br><br>
						<input class="form-check-input" type="checkbox" name="_2_2_3" id="_2_2_3" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							වලිප්පුව
						</label>
					</div>
					<div class="column4">
						...
						<input class="form-check-input" type="checkbox" name="_2_2_4" id="_2_2_4" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							අංශභාගය
						</label><br><br>
						<input class="form-check-input" type="checkbox" name="_2_2_5" id="_2_2_5" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							ඇදුම/ පෙනහලු රෝග
						</label><br><br>
						<input class="form-check-input" type="checkbox" name="_2_2_6" id="_2_2_6" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							අක්මා රෝග
						</label>
					</div>
					<div class="column4">
						...
						<input class="form-check-input" type="checkbox" name="_2_2_7" id="_2_2_7" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							රුධිර රෝග
						</label><br><br>
						<input class="form-check-input" type="checkbox" name="_2_2_8" id="_2_2_8" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							පිළිකා
						</label><br><br>
						<input class="form-check-input" type="checkbox" name="_2_2_9" id="_2_2_9" value="✓">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							වකුගඩු රෝගය
						</label>
					</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_2_3" id="_2_3" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_2_3" id="_2_3" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_2_4" id="_2_4" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_2_4" id="_2_4" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_2_5" id="_2_5" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_2_5" id="_2_5" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_2_6" id="_2_6" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_2_6" id="_2_6" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
		...
		<section>
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_3_1" id="_3_1" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_3_1" id="_3_1" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_3_2" id="_3_2" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_3_2" id="_3_2" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_4_1" id="_4_1" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_4_1" id="_4_1" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_4_2" id="_4_2" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_4_2" id="_4_2" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_4_3" id="_4_3" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_4_3" id="_4_3" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_4_4" id="_4_4" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_4_4" id="_4_4" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_4_5" id="_4_5" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_4_5" id="_4_5" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_4_6" id="_4_6" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_4_6" id="_4_6" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_5_1" id="_5_1" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_5_1" id="_5_1" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_5_2" id="_5_2" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_5_2" id="_5_2" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_5_3" id="_5_3" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_5_3" id="_5_3" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2">
					<input class="form-check-input" type="radio" name="_5_4" id="_5_4" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_5_4" id="_5_4" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2 red">
					<input class="form-check-input" type="radio" name="_6_1" id="_6_1" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_6_1" id="_6_1" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
			...
			<div class="row">
				...
				<div class="column2 red">
					<input class="form-check-input" type="radio" name="_6_2" id="_6_2" value="Tõ" required>
					<label for="flexRadioDefault1">
						ඔව්
					</label>
					</label>
					<input class="form-check-input" type="radio" name="_6_2" id="_6_2" value="ke;">
					<label value="0" class="form-check-label" for="flexRadioDefault1">
						නැත
					</label>
				</div>
		...
		<section>
			...
			<div class="form-row">
				<div class="form-holder">
					...
					<input type="text" class="form-control" placeholder="සම්පූර්ණ නම (ජාතික හැඳුනුම්පතට අනුව)" name="name" id="name" required>
				</div>
				<div class="form-holder"><i class="bi bi-gender-ambiguous"></i>
					<select class="form-control textbox-n" placeholder="" name="sex" id="sex" required>
			...
			<div class="form-row margin " style="">
				<div class="form-holder">
					...
					<input type="text" class="form-control" placeholder="ජාතික හැඳුනුම්පත් අංකය" name="nic" id="nic" required>
				</div>
				<div class="form-holder">
					<i class="bi bi-house-door"></i>
					<input type="text" class="form-control" placeholder="නිවසේ ලිපිනය (ස්ථිර/තාවකාලික)" name="address" id="address" required>
				</div>
			</div>
			<div class="form-row margin">
				<div class="form-holder"><i class="bi bi-droplet-fill"></i>
					<select class="form-control" id="bloodgroup" name="bloodgroup" value="">
						<option value="" selected disabled> රුධිර වර්ගය</option>
				...
				<div class="form-group">
					<div class="form-holder">
						...
						<input type="" id="dob" name="dob" class="form-control textbox-n" value="" placeholder="උපන්දිනය" onfocus="(this.type='date')" required>
					</div>
					<div class="form-holder">

						<input type="text" class="form-control" placeholder="වයස" name="age" id="age" required>
					</div>
				</div>
			</div>
			<div class="form-row margin">
				<div class="form-holder">
					...
					<input type="text" class="form-control" placeholder="දුරකථන අංකය" name="mobile" id="mobile" required>
				</div>
				<div class="form-holder">
					<i class="bi bi-envelope-fill"></i>
					<input type="text" class="form-control" placeholder="විද්‍යුත් තැපෑල" name="email" id="email">
				</div>
			...
			<div class="row">
				...
				<div class="row" style="text-align:center">
					<div class="column4">
						<input class="form-check-input" type="radio" name="_7" id="_7" value="udi y;rlg jrla" required>
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							මාස හතරකට වරක්
						</label>
					</div>
					<div class="column4">
						<input class="form-check-input" type="radio" name="_7" id="_7" value="udi 6lg jrla">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							මාස 6කට වරක්
						</label>
					</div>
					<div class="column4">
						<input class="form-check-input" type="radio" name="_7" id="_7" value="jirlg jrla">
						<label value="0" class="form-check-label" for="flexRadioDefault1">
							වසරකට වරක්
						</label>
					</div>
