                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card green">
                            ...
                            <i class="zmdi zmdi-upload"></i>
                            <div class="value"><?= $this->allBanks ?></div>
                            <div class="stat">In SRi Lanka</div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card orange">
                            <div class="title">Total Assigned Admins </div>
                            <i class="zmdi zmdi-download"></i>
                            <div class="value"><?= $this->allAdmin ?></div>
                            <div class="stat">In the system</div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card red">
...
<script type="text/javascript">
    ...
    function annualData(temp) {
        ...
        $.ajax({
            url: "http://localhost/bloodbank/reports/sadminCharts",
            method: "GET",
            dataType: "JSON",
            data: {
                bld_bank: blood
