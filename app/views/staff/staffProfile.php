              ...
              <div class="card">
                <div class="card-body">
                 ...
                 <?php if(isset($this->staffData->pro_img)) : ?>
                    <img src="<?=PROOT?>app/views/staff/pro_img/<?= $this->staffData->pro_img?>" alt="Admin" class="rounded-circle" height="200 "width="200">
                        <?php else: ?>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " target="__blank" href="<?=PROOT?>staff/editProfile/<?= $this->staffData->id ?> ">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
