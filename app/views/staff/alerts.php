 ...
 <section id="breadcrumbs" class="breadcrumbs">
      ...
      <section id="blog" class="blog">
        <div class="container" data-aos="fade-up">
          <div class="row">
        <center><div class="col-lg-8 entries">
               ...
               <?php if(alert(staff()->assigned)): ?>
                ...
                <div class="entry-content">
                  ...
                  <div>
                    ...
                    <button style="margin-left:100px" type="submit" class="btn btn-outline-danger"><a href="<?=PROOT?>staff/alertClose/<?= $this->date->bank?>" style="color:black" >Close This Alert</a></button>
                    </form>
                  </div>
                </div>
