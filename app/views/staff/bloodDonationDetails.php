...
<form action="<?=PROOT?>staff/searchDonors" method="post" style="margin-top:20px;text-align: center">
        ...
        //    });  
			...
			$("#search").load("http://localhost/bloodbank/staff/donationDetails");
		    ...
		    var from_date = $('#from_date').val();  
				...
				console.log(to_date);
				$.ajax({
					url:"http://localhost/bloodbank/staff/donationDetails",
					method:"POST",
					data:{ bld_banks:name, from_date:from_date , to_date:to_date},
			...
			$("#nic").keyup(function(){
				...
				$.ajax({
					url:"http://localhost/bloodbank/staff/donationDetails",
					method:"POST",
					data:{bld_banks:name, from_date:from_date , to_date:to_date ,nic:nic},
					success:function(data){
						console.log("This data", data); 
						$("#search").html(data);
